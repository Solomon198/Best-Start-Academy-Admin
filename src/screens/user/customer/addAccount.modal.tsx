...
import { AddCustomerAccount } from "./actions";
...
export default function AddAccount() {
  ...
  const { AddCustomerAccountStatus } = useSelector((store: any) => ({
    AddCustomerAccountStatus: store.Customer.AddCustomerAccountStatus,
  }));
  ...
  const addAccount = () => {
    dispatch({
      type: AddCustomerAccount.ADD_CUSTOMER_ACCOUNT_MANAGER_CALLER,
      payload: {
        photo,
        password,
        firstName,
